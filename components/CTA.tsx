  ...
  return (
    <section className="border-t border-white/8 px-5 py-28 md:px-8 md:py-36">
      <Reveal className="mx-auto max-w-3xl text-center">
        <p className="text-[12px] tracking-[0.22em] text-mute">HUNGRY?</p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            href="#how"
            className="inline-flex h-12 items-center rounded-full border border-white/14 px-6 text-[14px] font-medium transition hover:bg-white/5"
          >
            See How It Works
          </a>
        </div>
